...
import (
	...
	"github.com/jinuthankachan/oapi-codegen/v2/examples/authenticated-api/stdhttp/api"
	"github.com/jinuthankachan/oapi-codegen/v2/examples/authenticated-api/stdhttp/server"
)
