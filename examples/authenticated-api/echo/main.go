...
import (
	...
	"github.com/jinuthankachan/oapi-codegen/v2/examples/authenticated-api/echo/api"
	"github.com/jinuthankachan/oapi-codegen/v2/examples/authenticated-api/echo/server"
)
